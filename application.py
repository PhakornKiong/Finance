...
#app.config["SESSION_FILE_DIR"] = mkdtemp() TEMPORARY DISABLE DUE TO HEROKU COOKIES
    ...
    if request.method == "POST":
        ...
        if user_balance >= transaction_amount: # checks user can afford
            ...
            if list_shares:
                ...
                db.execute("UPDATE Portfolios SET shares = :totalshares WHERE id = :id AND symbol =:symbol", totalshares=totalshares, id=id, symbol=symbol)
            else:
